// Based on script being placed in ./pdfs folder
const pdfFiller = ('../node_modules/pdffiller-stream/index.js');

const sourcePDF = "./sc/sc100-fillable2.pdf";
...
const data = { 
  ...
  State_7: '',
  Zip_7: '',
  'Check here if your case is against more than one defendant and attach form SC100A': '',
  ...
  pg2_s1_pListNames: '',
  pg2_s1_caseNum: '',
  pg2_s2_p1_name: 'Malak Lopez',
  pg2_s2_p1_phone: '213-884-8259',
